...
const CalendarDayIcon = () => {
  ...
  return (
    <div className="flex flex-col overflow-hidden w-4 h-4 rounded-t-sm">
      <div className="bg-red-600 text-[4px] font-bold text-white text-center leading-[6px]">
        {month}
      </div>
      <div className="flex-1 flex items-center justify-center">
        <span className="text-[8px] font-light text-white leading-none">{day}</span>
      </div>
    </div>
  );
};
  ...
  useEffect(() => {
    setDockItems([
      ...
      },
      {
        ...
        description: t("settings.dock.notes.description"),
        icon: Icons.note,
      ...
      },
      {
        ...
        description: t("settings.dock.calendar.description"),
